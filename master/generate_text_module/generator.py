...
def build_message(context, prompt_input, image_link, chat_history):
    ...
    system_content = (
        ...
        f"you could: "
        f"- Include 3 to 5 products in the líst."
...
def build_message_intent(prompt_input):
    system_content = (
        ...
        f"If the user ask or mention about voucher or sales event such as: mã giảm giá, khuyến mãi or anything relate to the topic. Classify it as 'specific_information'"
        ...
        f"If the user ask or mention about custom made flower, hoa tuỳ chỉnh, hoa custom or hoa tự tạo and how to use the system for these type of flower product. Classify it as 'shop_information'"
        f"If user try to ask or mention about other user personal information or sensitive information. Classify it as 'invalid_question'"
