...
class MysqlService(object):
    ...
    def get_product_on_id(self, result_list):
        ...
        for result in result_list:
            self.cursor.execute("Select name, price, stock, description, is_active from flowerplus.products where id = %s and product_type = 0 and is_custom = 0", result["product_id"])
